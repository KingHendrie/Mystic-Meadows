...
class Plant(pygame.sprite.Sprite):
	def __init__(self, plant_type, groups, soil, check_watered):
		...
		self.frames = import_folder(f'assets/sprites/fruit/{plant_type}')
		self.soil = soil
...
class SoilLayer():
	def __init__(self, all_sprites, collision_sprites):
		...
		# Graphics
		self.soil_surfs = import_folder_dict('assets/sprites/soil')
		self.water_surfs = import_folder('assets/sprites/soil_water')
	...
	def create_soil_grid(self):
		ground = pygame.image.load('assets/sprites/world/ground.png')
		...
		for soil_sprite in self.soil_sprites.sprites():
			if soil_sprite.rect.collidepoint(target_pos):
				...
				if 'P' not in self.grid[y][x]:
					...
					Plant(
						plant_type = seed,
						groups = [self.all_sprites, self.collision_sprites, self.plant_sprites],
						soil = soil_sprite,
	...
	# TODO: Improve logic with corners
